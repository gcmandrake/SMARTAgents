...
public class FillStationPassThroughBehaviour {
	...
	public FillStationPassThroughBehaviour(PLCClient client) {
		
		if (client != null) {
			this.client = client;
		} else {
			System.out.println("FillStationPassThroughBehaviour passed null client");
		}
	}
