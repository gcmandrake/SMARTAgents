...
public class DispatchContainerPassThroughBehaviour {	
	...
	public DispatchContainerPassThroughBehaviour(PLCClient client) {		
		
		
		if (client != null) {
			this.client = client;
		} else {
			System.out.println("DispatchContainerPassThroughBehaviour passed null client");
		}
	}
	...
	public boolean sendMessagesToPLC() {
		...
		try {	
			...
			req = new Message(Message.WRITE, Message.BOOL, String.valueOf(false), Message.LOCAL, "Go_Pallet");
