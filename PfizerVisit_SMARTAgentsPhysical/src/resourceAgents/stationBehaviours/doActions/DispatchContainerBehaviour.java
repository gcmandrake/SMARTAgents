...
public class DispatchContainerBehaviour {	
	...
	public DispatchContainerBehaviour(Requirement requirement, PLCClient client) {
		
		if (requirement != null) {
			this.requirement = requirement;
		} else {
			System.out.println("DispatchContainerBehaviour passed null requirement");
		}
		
		if (client != null) {
			this.client = client;
		} else {
			System.out.println("DispatchContainerBehaviour passed null client");
		}
	}
	...
	public boolean sendMessagesToPLC() {
		...
		try {	
			...
			req = new Message(Message.WRITE, Message.BOOL, String.valueOf(true), Message.LOCAL, "Go_Pallet");
