...
public class KeyValuePairTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_size(
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.target );
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst,boolean serialize_encapsulation,
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.key,(255));

            dst.writeString(typedSrc.source,(255));

            dst.writeString(typedSrc.target,(255));
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.key = src.readString((255));
                typedDst.source = src.readString((255));
                typedDst.target = src.readString((255));
