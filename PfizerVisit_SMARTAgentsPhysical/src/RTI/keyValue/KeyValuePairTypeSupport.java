 ...
 * KeyValuePair.
 */
public class KeyValuePairTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final KeyValuePairTypeSupport _singleton
        = new KeyValuePairTypeSupport();
     ...
     */
    public static KeyValuePairTypeSupport get_instance() {
        return _singleton;
    }

    public static KeyValuePairTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>KeyValuePair</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        KeyValuePair typedDst = (KeyValuePair) destination;
        KeyValuePair typedSrc = (KeyValuePair) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((60000)) + 1);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        KeyValuePair typedSrc = (KeyValuePair) sample;
...
KeyValuePair typedSrc = (KeyValuePair) src;    
        ...
        dst.writeString(typedSrc.key,(60000));
            
        dst.writeString(typedSrc.source,(60000));
            
        dst.writeString(typedSrc.value,(60000));
...
KeyValuePair typedDst = (KeyValuePair) dst;
        
            typedDst.clear();
    try {

            typedDst.key = src.readString((60000));
            
            typedDst.source = src.readString((60000));
            
            typedDst.value = src.readString((60000));
...
KeyValuePair typedDst = (KeyValuePair) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
KeyValuePair typedDst = (KeyValuePair) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        KeyValuePair typedDst
            = (KeyValuePair) instance;
        KeyValuePair typedSrc
            = (KeyValuePair) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new KeyValuePairDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new KeyValuePairDataReader(native_reader, listener, mask, this);                
    ...
    protected KeyValuePairTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,KeyValuePairTypeCode.VALUE,KeyValuePair.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected KeyValuePairTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,KeyValuePairTypeCode.VALUE,KeyValuePair.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
