...
public class KeyValuePairPublisher {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        KeyValuePairDataWriter writer = null;
        ...
        try {
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("Writing KeyValuePair, count " + count);
