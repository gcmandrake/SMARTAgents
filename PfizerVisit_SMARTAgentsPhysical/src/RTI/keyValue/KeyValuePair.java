...
public class KeyValuePair   implements Copyable, Serializable{
    ...
    public String key=  "" ; /* maximum length = (255) */
    public String source=  "" ; /* maximum length = (255) */
    public String target=  "" ; /* maximum length = (255) */
    ...
    public Object copy_from(Object src) {
        ...
        typedDst.target = typedSrc.target;
    ...
    public String toString(String desc, int indent) {
        ...
        CdrHelper.printIndent(strBuffer, indent+1);        
        strBuffer.append("target: ").append(target).append("\n");  
        CdrHelper.printIndent(strBuffer, indent+1);        
