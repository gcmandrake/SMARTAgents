...
public class KeyValuePairSubscriber {
    // -----------------------------------------------------------------------
        // Public Methods
        // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
        ...
        private KeyValuePairSubscriber() {
        super();
    }
    ...
    // -----------------------------------------------------------------------
        ...
        KeyValuePairDataReader reader = null;
        ...
        try {
            ...
            listener = new KeyValuePairListener();

            /* To customize data reader QoS, use
                           the configuration file USER_QOS_PROFILES.xml */

            reader = (KeyValuePairDataReader)
            ...
            ++count) {
                System.out.println("KeyValuePair subscriber sleeping for "
    ...
    // -----------------------------------------------------------------------
        ...
        private static class KeyValuePairListener extends DataReaderAdapter {
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                                                    ((KeyValuePair)_dataSeq.get(i)).toString("Received",0));
