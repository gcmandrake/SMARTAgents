...
/* TestACLSubscriber.java

   A publication of data of type TestACL
   ...
   Example publication of type TestACL automatically generated by 
   'rtiddsgen' To test them follow these steps:

   (1) Compile this file and the example subscription.

   (2) Start the subscription on the same domain used for with the command
       java TestACLSubscriber <domain_id> <sample_count>

   (3) Start the publication with the command
       java TestACLPublisher <domain_id> <sample_count>
   ...
   Example:
       ...
       Run the Java applications:
        ...
        java -Djava.ext.dirs=$NDDSHOME/class TestACLPublisher <domain_id>

        java -Djava.ext.dirs=$NDDSHOME/class TestACLSubscriber <domain_id>  
...
public class TestACLSubscriber {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static class TestACLListener extends DataReaderAdapter {
