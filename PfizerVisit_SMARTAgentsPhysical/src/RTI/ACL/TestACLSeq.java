...
/**
 * A sequence of TestACL instances.
 */
public final class TestACLSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TestACLSeq(int initialMaximum) {
        super(TestACL.class, initialMaximum);
    }


    public TestACLSeq(Collection elements) {
        super(TestACL.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, TestACL.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }
        
        // copy 'new' TestACL objects (beyond the original size of this object)
