 ...
 * TestACL.
 */
public class TestACLTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "TestACL";
    ...
    private static final TestACLTypeSupport _singleton
        = new TestACLTypeSupport();
     ...
     */
    public static TestACLTypeSupport get_instance() {
        return _singleton;
    }

    public static TestACLTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TestACL.create();
    }
     ...
     * <code>this</code> is not a <code>TestACL</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TestACL typedDst = (TestACL) destination;
        TestACL typedSrc = (TestACL) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TestACL typedSrc = (TestACL) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.serialisedMessage);
...
TestACL typedSrc = (TestACL) src;    
        ...
        dst.writeString(typedSrc.serialisedMessage,(60000));
...
TestACL typedDst = (TestACL) dst;
        
            typedDst.clear();
    try {

            typedDst.serialisedMessage = src.readString((60000));
...
TestACL typedDst = (TestACL) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TestACL typedDst = (TestACL) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TestACLDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TestACLDataReader(native_reader, listener, mask, this);                
    ...
    protected TestACLTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TestACLTypeCode.VALUE,TestACL.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TestACLTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TestACLTypeCode.VALUE,TestACL.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
